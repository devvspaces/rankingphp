    ...
    <div id="board">
      ...
      <?php foreach ($ranks as $i => $ranks) : ?>
        ...
        <div class="rank-parent" num=<?php echo $i + 1;  ?>>
          ...
          <div class="rank-card" data-long-press-delay="300" rankID=<?php echo $ranks['id'] ?>>
            ...
            <div class="rank-content">
              ...
              <div class="maxes">
                <p>Highest: <span class="highest"><?php if ($ranks['highest']) { echo $ranks['highest']; } ?></span></p>
                <p>Lowest: <span class="lowest"><?php if ($ranks['lowest']) { echo $ranks['lowest']; } ?></span></p>
              </div>
...
<script src="/assets/js/long-press-event.min.js"></script>

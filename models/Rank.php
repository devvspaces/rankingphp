<?php
    ...
    class Rank {
        ...
        public function save(){
            ...
            // if (!$this->position){
            //     $errors[] = 'Please provide a rank position';
            // }

            // if (!$this->count){
            //     $errors[] = 'Please provide a rank count';
            // }

            // if (!$this->movement){
            //     $errors[] = 'Please provide a rank movement';
            // }
            ...
            if (empty($errors)){
                ...
                if ($this->imageFile && $this->imageFile['tmp_name']){
                    ...
                    if ($this->imagePath){
                        rmdir(dirname(__DIR__ . '/../public/' . $this->imagePath));
                    }

                    $this->imagePath = 'images/' . UtilHelper::getUniqueDir() . '/' . $this->imageFile['name'];

                    // Create dir
                    $relpath = __DIR__ . '/../public/' . $this->imagePath;
